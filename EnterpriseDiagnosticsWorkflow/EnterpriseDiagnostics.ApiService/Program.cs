...
{
    options.RegisterActivity<HullIntegrityAnalysisActivity>();
    options.RegisterActivity<LifeSupportAnalysisActivity>();
    options.RegisterActivity<WarpCoreAnalysisActivity>();
    options.RegisterActivity<SummarizeResultsActivity>();
