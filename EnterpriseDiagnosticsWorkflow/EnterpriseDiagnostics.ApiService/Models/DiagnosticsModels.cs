...
public record AnalysisRequest(string Stardate);
...
public record SummaryResult(string Summary, bool HasCritical);

public record BridgeNotification(string Stardate, string Message);
